...
using ColliderSystem_Runtime_Mesh = VladislavTsurikov.ColliderSystem.Runtime.Mesh;
using Mesh = VladislavTsurikov.ColliderSystem.Runtime.Mesh;
using Runtime_Mesh = VladislavTsurikov.ColliderSystem.Runtime.Mesh;
                        ...
                        case DebugObjectMode.ShowMeshTree:
                        {
                            if(_objectRayHit != null)
                            {
                                if (_objectRayHit.MeshRayHit != null)
                                {
                                    ...
                                    ColliderSystem_Runtime_Mesh editorMesh = _bvhObject.GetMesh();
